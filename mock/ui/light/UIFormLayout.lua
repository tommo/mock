...
CLASS: UIFormLayout ( UILayout )
	:MODEL{
		Field 'size' :type( 'vec2' ) :getset( 'Size' ) :meta{ decimals = 0 };
		Field 'rowHeight' :getset( 'RowHeight' );
		Field 'labelSize' :getset( 'LabelSize' );
		'----';
		Field 'margin' :type('vec4') :getset( 'Margin' );
		Field 'spacingX' :getset( 'SpacingX' );
	}

registerComponent( 'UIFormLayout', UIFormLayout )
...
-- function UIFormLayout:getSize()
-- 	return self.width, self.height
-- end

-- function UIFormLayout:setSize( w, h )
-- 	self.width, self.height = w, h
-- 	self:invalidate()
-- end


-- function UIFormLayout:setSpacingX( s )
-- 	self.spacingX = s
-- 	self:invalidate()
-- end

-- function UIFormLayout:getSpacingX()
-- 	return self.spacingX
-- end

-- function UIFormLayout:setSpacingY( s )
-- 	self.spacingY = s
-- 	self:invalidate()
-- end

-- function UIFormLayout:getSpacingY()
-- 	return self.spacingY
-- end

-- function UIFormLayout:getSpacing()
-- 	return self.spacingX, self.spacingY
-- end

-- function UIFormLayout:setSpacing( x, y )
-- 	x = x or 0
-- 	y = y or x
-- 	self.spacingX = x
-- 	self.spacingY = y
...
-- function UIFormLayout:calcSize( count )
...
-- function UIFormLayout:getGridSize()
-- 	return self.gridWidth, self.gridHeight
-- end

-- function UIFormLayout:setGridSize( w, h )
-- 	self.gridWidth, self.gridHeight = w, h
-- 	self:invalidate()
-- end

-- function UIFormLayout:onUpdate()
